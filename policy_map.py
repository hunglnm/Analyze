class Policy_map:
    ...
    def insert(self, cursor):
        add_policy_map = ("INSERT INTO Policy_map "
                          ...
                          "Service_policy,RED_Agg,RED_Pre,RED_Min,RED_Max,RED_Mark,8021p) "
                          ...
                          "RED_Min=VALUES(RED_Min),RED_Max=VALUES(RED_Max),RED_Mark=VALUES(RED_Mark),8021p=VALUES(8021p)")
        data_policy_map = (self.Name,Policy_map.Hostname,self.Class,self.Police,self.Shape,self.CIR, \
                           ...
                           self.RED_Agg,self.RED_Pre,self.RED_Min,self.RED_Max,self.RED_Mark,self.p1)
